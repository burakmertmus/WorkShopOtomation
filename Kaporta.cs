...
namespace $safeprojectname$
{
    public class Kaporta:Tamirhane
    {
        ...
        List<Parca> degisenList;
        List<Parca> boyananList;
        public Kaporta() { }
        public Kaporta(string plaka, int bolum)
            : base(plaka, bolum)
        {
            this.plaka = plaka;
         ...
         public List<Parca> getDegisen()
        {
            ...
            komut.CommandText = "Select *From dbo.islemTablo where plaka='" + plaka + "'and bolum=0 ";
